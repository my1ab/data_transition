...
def generate_coldstart_data(output_file, num_cpus=0.1, num_samples=500, turns=50, use_ray=False, use_para=0, show_turn=False, 
                            ...
                            only_test=0, prompt=1, limit_goals=-1, ds_model=1, effort=1):
    """
    ...
    env_msg4 = f'ds_model: {ds_model} ({model_name})'
    ...
    print(env_msg1), print(env_msg2), print(env_msg3), print(env_msg4)
...
if __name__ == "__main__":
    ...
    if move == 1:
        ...
        generate_coldstart_data(OUTPUT_FILE, num_samples=6, turns=25, 
                                # use_ray=False, 
                                num_cpus=1,
                                use_para=1, num_para=5, group_n=1, env_num=5,
                                show_turn=1, use_history=0, load_all=1, 
                                human_goals=True, 
                                # human_goals=False,
                                # only_test=1,
                                # limit_goals=1012
        ...
        # generate_coldstart_data(OUTPUT_FILE, num_samples=15, turns=30, 
        #                         # use_ray=False, 
        #                         num_cpus=0.5,
        #                         use_para=1, num_para=5, group_n=1, env_num=5,
        #                         show_turn=1, use_history=0, load_all=1, 
        ...
        #                         prompt=1,
        #                         # limit_goals=1012
        #                         ds_model=2  # 1: flash model, 2: pro model
        #                         )
