...
**Important rules:**
- only 3 kinds of acts are allowed: search, click, null
- 4 kinds of tags are allowed: <think> </think>, <action> </action>, <parallel> </parallel>, <env_i> </env_i>
...
Now it's your turn to take actions for the current step.
...
when environments didn't change, check the format of your output of your output.
"""
